...
def heart_markers(
    ...
    mouse = {
        ...
        'VeinEC': ['Mgp', 'Cfh', 'Apoe', 'Cpe', 'Bgn', 'Vwf', 'Fabp5', 'Vcam1', 'H19', 'Tmem108', 'F2r', 'Ptgs1',
                   'Il6st',
    ...
    human = {cell: [gene.upper() for gene in mouse[cell]]
                      for cell in mouse}  # Cell Type Markers in Human Format
...
def standard_ct_labels_heart(
    ...
    'EC8_ln': 'LymphEC',
    'FB3': 'Fibroblasts',  # FB3 is less abundant in the left ventricule, more in the atria
