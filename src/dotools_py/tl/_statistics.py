...
from scipy.stats import false_discovery_control, rv_discrete, rv_continuous
from dotools_py import logger

def cts_perm(adata: ad.AnnData,
             ref: str,
    ...
    """Test for differential number of interactions between cell-types.

    Calculate differential number of connections between cell-types comparing across
    two conditions. The significance is tested using permutation test.
