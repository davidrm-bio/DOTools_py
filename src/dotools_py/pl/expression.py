...
def cell_props(
    ...
    **kwargs,
    ...
    :param annot_order: .obs column name with sample information. If None or the data has no replicates, then replicates
                     will be simulated. Additional arguments can be provided to control simulations.
                     See `scanpro <https://github.com/loosolab/scanpro>`_ documentation.
    ...
    :param bar_width: the bars width
